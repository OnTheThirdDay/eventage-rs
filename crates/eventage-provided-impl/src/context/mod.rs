...
// Re-export core context types so users can access them from this module path.
pub use eventage_agent::{events_to_messages, AssemblyContext, ContextAssembler};
use eventage_core::{kinds, Event, EventId};
use eventage_llm::types::{ChatMessage, Role};
