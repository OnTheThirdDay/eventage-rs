...
//! Adapted from example-coding-agent/src/tools/fs.rs — work_dir is scoped
//! to the group's data folder instead of a code workspace.
        ...
        ToolDefinition::function(
            ...
            json!({
                ...
                "properties": {
                    ...
                    "include": { "type": "string", "description": "Glob to filter files, e.g. '*.md'." }
                },
                "required": ["pattern"]
            }),
        )
